package com.pentas.clientmobile.common.exception;
...
public class UserException extends BaseException {
     ...
     */
    public UserException(String defaultMessage, Exception wrappedException)
    {
     ...
     * @param 	wrappedException throw 된 Exception Object
     */
    public UserException(String defaultMessage, Object messageParameters[], Exception wrappedException)
    {
     ...
     * @param 	wrappedException throw 된 Exception Object
     */
    public UserException(MessageSource messageSource, String messageKey, Exception wrappedException)
    {
     ...
     * @param 	wrappedException throw 된 Exception Object
     */
    public UserException(MessageSource messageSource, String messageKey, Locale locale, Exception wrappedException)
    {
     ...
     * @param 	wrappedException throw 된 Exception Object
     */
    public UserException(MessageSource messageSource, String messageKey, Object messageParameters[], Locale locale, Exception wrappedException)
    {
     ...
     * @param 	wrappedException throw 된 Exception Object
     */
    public UserException(MessageSource messageSource, String messageKey, Object messageParameters[], Exception wrappedException)
    {
     ...
     * @param 	wrappedException throw 된 Exception Object
     */
    public UserException(MessageSource messageSource, String messageKey, Object messageParameters[], String defaultMessage, Exception wrappedException)
    {
     ...
     * @param 	wrappedException throw 된 Exception Object
     */
    public UserException(MessageSource messageSource, String messageKey, Object messageParameters[], String defaultMessage, Locale locale, Exception wrappedException)
    {
